...
IMAGES_DIR = "C:/Users/labed/Desktop/fruit"

# Fruit definitions with image paths
FRUITS = [
    {'name': 'Purple Devil Fruit', 'image':'596e67f8f559d2865824bb7554d0ea3b.png', 'key': pygame.K_p, 'letter': 'P'},
    {'name': 'Fire Devil Fruit', 'image': 'C:\Users\labed\Desktop\fruit\858dacd62efdb4774784e9dbebe174f3.png', 'key': pygame.K_o, 'letter': 'F'},
    {'name': 'Heart Devil Fruit', 'image': 'C:\Users\labed\Desktop\fruit\1113a891663c7a600ac4536c94554a1d.png', 'key': pygame.K_h, 'letter': 'H'},
    {'name': 'Blue Devil Fruit', 'image': 'C:\Users\labed\Desktop\fruit\tlchargement.png', 'key': pygame.K_b, 'letter': 'B'},
]

SPECIAL_ITEMS = [
    {'name': 'Ice Cube', 'image': '"C:\Users\labed\Desktop\fruit\9f542496ae8dbf45ed1983b2e0aa2ab1.png"',  'key': pygame.K_i, 'letter': 'I', 'type': 'ice'},
    {'name': 'Bomb', 'image': 'C:\Users\labed\Desktop\fruit\e9a1f569a0005ff14f58fdfbdf5ede68.png',  'key': pygame.K_x, 'letter': 'X', 'type': 'bomb'},
]
...
class Fruit:
    def __init__(self, fruit_data, x, y, image_cache):
        ...
        self.gravity = 0.3 # Gravity pulls down
